...
THREE.BinaryLoader.prototype.createBinModel=function(a,b,c,d){var f=function(b){var c,f,i,l,j,o,m,p,q,n,s,r,u,v,t;function A(a){return a%4?4-a%4:0}function y(a,b){return(new Uint8Array(a,b,1))[0]}function B(a,b){return(new Uint32Array(a,b,1))[0]}function G(b,c){var d,f,e,g,h,i,j,l,n=new Uint32Array(a,c,3*b);for(d=0;d<b;d++){f=n[d*3];e=n[d*3+1];g=n[d*3+2];h=P[f*2];f=P[f*2+1];i=P[e*2];j=P[e*2+1];e=P[g*2];l=P[g*2+1];g=M.faceVertexUvs[0];var o=[];o.push(new THREE.UV(h,f));o.push(new THREE.UV(i,j));o.push(new THREE.UV(e,
l));g.push(o)}}function x(b,c){var d,f,e,g,h,i,j,l,n,o,m=new Uint32Array(a,c,4*b);for(d=0;d<b;d++){f=m[d*4];e=m[d*4+1];g=m[d*4+2];h=m[d*4+3];i=P[f*2];f=P[f*2+1];j=P[e*2];n=P[e*2+1];l=P[g*2];o=P[g*2+1];g=P[h*2];e=P[h*2+1];h=M.faceVertexUvs[0];var p=[];p.push(new THREE.UV(i,f));p.push(new THREE.UV(j,n));p.push(new THREE.UV(l,o));p.push(new THREE.UV(g,e));h.push(p)}}function I(b,c,d){for(var f,e,g,h,c=new Uint32Array(a,c,3*b),i=new Uint16Array(a,d,b),d=0;d<b;d++){f=c[d*3];e=c[d*3+1];g=c[d*3+2];h=i[d];
M.faces.push(new THREE.Face3(f,e,g,null,null,h))}}function F(b,c,d){for(var f,e,g,h,i,c=new Uint32Array(a,c,4*b),j=new Uint16Array(a,d,b),d=0;d<b;d++){f=c[d*4];e=c[d*4+1];g=c[d*4+2];h=c[d*4+3];i=j[d];M.faces.push(new THREE.Face4(f,e,g,h,null,null,i))}}function L(b,c,d,f){for(var e,g,h,i,j,l,n,c=new Uint32Array(a,c,3*b),d=new Uint32Array(a,d,3*b),o=new Uint16Array(a,f,b),f=0;f<b;f++){e=c[f*3];g=c[f*3+1];h=c[f*3+2];j=d[f*3];l=d[f*3+1];n=d[f*3+2];i=o[f];var m=E[l*3],p=E[l*3+1];l=E[l*3+2];var q=E[n*3],
t=E[n*3+1];n=E[n*3+2];M.faces.push(new THREE.Face3(e,g,h,[new THREE.Vector3(E[j*3],E[j*3+1],E[j*3+2]),new THREE.Vector3(m,p,l),new THREE.Vector3(q,t,n)],null,i))}}function H(b,c,d,f){for(var e,g,h,i,j,l,n,o,m,c=new Uint32Array(a,c,4*b),d=new Uint32Array(a,d,4*b),p=new Uint16Array(a,f,b),f=0;f<b;f++){e=c[f*4];g=c[f*4+1];h=c[f*4+2];i=c[f*4+3];l=d[f*4];n=d[f*4+1];o=d[f*4+2];m=d[f*4+3];j=p[f];var q=E[n*3],t=E[n*3+1];n=E[n*3+2];var r=E[o*3],s=E[o*3+1];o=E[o*3+2];var u=E[m*3],v=E[m*3+1];m=E[m*3+2];M.faces.push(new THREE.Face4(e,
g,h,i,[new THREE.Vector3(E[l*3],E[l*3+1],E[l*3+2]),new THREE.Vector3(q,t,n),new THREE.Vector3(r,s,o),new THREE.Vector3(u,v,m)],null,j))}}var M=this,C=0,E=[],P=[],N,Q,Y;THREE.Geometry.call(this);THREE.Loader.prototype.initMaterials(M,d,b);t=a;Q=C;b=new Uint8Array(t,Q,12);n="";for(u=0;u<12;u++)n=n+String.fromCharCode(b[Q+u]);c=y(t,Q+12);y(t,Q+13);y(t,Q+14);y(t,Q+15);f=y(t,Q+16);i=y(t,Q+17);l=y(t,Q+18);j=y(t,Q+19);o=B(t,Q+20);m=B(t,Q+20+4);p=B(t,Q+20+8);q=B(t,Q+20+12);n=B(t,Q+20+16);s=B(t,Q+20+20);r=
...
c,d;for(b in a.attributes){d=b==="index"?k.ELEMENT_ARRAY_BUFFER:k.ARRAY_BUFFER;c=a.attributes[b];c.buffer=k.createBuffer();k.bindBuffer(d,c.buffer);k.bufferData(d,c.array,k.STATIC_DRAW)}}function g(a,b,c){var d,f,e,g,h=a.vertices;g=h.length;var i=a.colors,j=i.length,l=a.__vertexArray,n=a.__colorArray,m=a.__sortArray,o=a.verticesNeedUpdate,p=a.colorsNeedUpdate,q=a.__webglCustomAttributesList;if(c.sortParticles){gb.copy(bb);gb.multiplySelf(c.matrixWorld);for(d=0;d<g;d++){f=h[d];Pa.copy(f);gb.multiplyVector3(Pa);
m[d]=[Pa.z,d]}m.sort(function(a,b){return b[0]-a[0]});for(d=0;d<g;d++){f=h[m[d][1]];e=d*3;l[e]=f.x;l[e+1]=f.y;l[e+2]=f.z}for(d=0;d<j;d++){e=d*3;f=i[m[d][1]];n[e]=f.r;n[e+1]=f.g;n[e+2]=f.b}if(q){i=0;for(j=q.length;i<j;i++){h=q[i];if(h.boundTo===void 0||h.boundTo==="vertices"){e=0;f=h.value.length;if(h.size===1)for(d=0;d<f;d++){g=m[d][1];h.array[d]=h.value[g]}else if(h.size===2)for(d=0;d<f;d++){g=m[d][1];g=h.value[g];h.array[e]=g.x;h.array[e+1]=g.y;e=e+2}else if(h.size===3)if(h.type==="c")for(d=0;d<
f;d++){g=m[d][1];g=h.value[g];h.array[e]=g.r;h.array[e+1]=g.g;h.array[e+2]=g.b;e=e+3}else for(d=0;d<f;d++){g=m[d][1];g=h.value[g];h.array[e]=g.x;h.array[e+1]=g.y;h.array[e+2]=g.z;e=e+3}else if(h.size===4)for(d=0;d<f;d++){g=m[d][1];g=h.value[g];h.array[e]=g.x;h.array[e+1]=g.y;h.array[e+2]=g.z;h.array[e+3]=g.w;e=e+4}}}}}else{if(o)for(d=0;d<g;d++){f=h[d];e=d*3;l[e]=f.x;l[e+1]=f.y;l[e+2]=f.z}if(p)for(d=0;d<j;d++){f=i[d];e=d*3;n[e]=f.r;n[e+1]=f.g;n[e+2]=f.b}if(q){i=0;for(j=q.length;i<j;i++){h=q[i];if(h.needsUpdate&&
...
c.density}if(d instanceof THREE.MeshPhongMaterial||d instanceof THREE.MeshLambertMaterial||d.lights){if(hb){for(var l=0,n=0,m=0,o,p,q,r,t=qc,s=t.directional.colors,u=t.directional.positions,x=t.point.colors,B=t.point.positions,C=t.point.distances,G=t.spot.colors,F=t.spot.positions,K=t.spot.distances,E=t.spot.directions,J=t.spot.angles,L=t.spot.exponents,N=t.hemi.skyColors,V=t.hemi.groundColors,P=t.hemi.positions,Q=0,ca=0,Y=0,fa=0,c=o=q=q=p=0,e=b.length;c<e;c++){j=b[c];if(!j.onlyShadow&&j.visible){o=
j.color;r=j.intensity;p=j.distance;if(j instanceof THREE.AmbientLight)if(O.gammaInput){l=l+o.r*o.r;n=n+o.g*o.g;m=m+o.b*o.b}else{l=l+o.r;n=n+o.g;m=m+o.b}else if(j instanceof THREE.DirectionalLight){p=Q*3;O.gammaInput?A(s,p,o,r*r):y(s,p,o,r);Qa.copy(j.matrixWorld.getPosition());Qa.subSelf(j.target.matrixWorld.getPosition());Qa.normalize();u[p]=Qa.x;u[p+1]=Qa.y;u[p+2]=Qa.z;Q=Q+1}else if(j instanceof THREE.PointLight){q=ca*3;O.gammaInput?A(x,q,o,r*r):y(x,q,o,r);r=j.matrixWorld.getPosition();B[q]=r.x;
B[q+1]=r.y;B[q+2]=r.z;C[ca]=p;ca=ca+1}else if(j instanceof THREE.SpotLight){q=Y*3;O.gammaInput?A(G,q,o,r*r):y(G,q,o,r);r=j.matrixWorld.getPosition();F[q]=r.x;F[q+1]=r.y;F[q+2]=r.z;K[Y]=p;Qa.copy(r);Qa.subSelf(j.target.matrixWorld.getPosition());Qa.normalize();E[q]=Qa.x;E[q+1]=Qa.y;E[q+2]=Qa.z;J[Y]=Math.cos(j.angle);L[Y]=j.exponent;Y=Y+1}else if(j instanceof THREE.HemisphereLight){p=j.color;q=j.groundColor;o=fa*3;if(O.gammaInput){r=r*r;A(N,o,p,r);A(V,o,q,r)}else{y(N,o,p,r);y(V,o,q,r)}r=j.matrixWorld.getPosition();
P[o]=r.x;P[o+1]=r.y;P[o+2]=r.z;fa=fa+1}}}c=Q*3;for(e=s.length;c<e;c++)s[c]=0;c=ca*3;for(e=x.length;c<e;c++)x[c]=0;c=Y*3;for(e=G.length;c<e;c++)G[c]=0;c=fa*3;for(e=N.length;c<e;c++)N[c]=0;c=fa*3;for(e=V.length;c<e;c++)V[c]=0;t.directional.length=Q;t.point.length=ca;t.spot.length=Y;t.hemi.length=fa;t.ambient[0]=l;t.ambient[1]=n;t.ambient[2]=m;hb=false}c=qc;i.ambientLightColor.value=c.ambient;i.directionalLightColor.value=c.directional.colors;i.directionalLightDirection.value=c.directional.positions;
...
c._array[m+1]=j[l].y}k.uniform2fv(e,c._array)}else if(l==="v3v"){if(c._array===void 0)c._array=new Float32Array(3*j.length);l=0;for(n=j.length;l<n;l++){m=l*3;c._array[m]=j[l].x;c._array[m+1]=j[l].y;c._array[m+2]=j[l].z}k.uniform3fv(e,c._array)}else if(l==="v4v"){if(c._array===void 0)c._array=new Float32Array(4*j.length);l=0;for(n=j.length;l<n;l++){m=l*4;c._array[m]=j[l].x;c._array[m+1]=j[l].y;c._array[m+2]=j[l].z;c._array[m+3]=j[l].w}k.uniform4fv(e,c._array)}else if(l==="m4"){if(c._array===void 0)c._array=
new Float32Array(16);j.flattenToArray(c._array);k.uniformMatrix4fv(e,false,c._array)}else if(l==="m4v"){if(c._array===void 0)c._array=new Float32Array(16*j.length);l=0;for(n=j.length;l<n;l++)j[l].flattenToArrayOffset(c._array,l*16);k.uniformMatrix4fv(e,false,c._array)}else if(l==="t"){m=j;j=v();k.uniform1i(e,j);if(m)if(m.image instanceof Array&&m.image.length===6){c=m;e=j;if(c.image.length===6)if(c.needsUpdate){if(!c.image.__webglTextureCube)c.image.__webglTextureCube=k.createTexture();k.activeTexture(k.TEXTURE0+
e);k.bindTexture(k.TEXTURE_CUBE_MAP,c.image.__webglTextureCube);k.pixelStorei(k.UNPACK_FLIP_Y_WEBGL,c.flipY);e=[];for(j=0;j<6;j++)if(O.autoScaleCubemaps){l=e;n=j;m=c.image[j];s=Sc;if(!(m.width<=s&&m.height<=s)){u=Math.max(m.width,m.height);t=Math.floor(m.width*s/u);s=Math.floor(m.height*s/u);u=document.createElement("canvas");u.width=t;u.height=s;u.getContext("2d").drawImage(m,0,0,m.width,m.height,0,0,t,s);m=u}l[n]=m}else e[j]=c.image[j];j=e[0];l=(j.width&j.width-1)===0&&(j.height&j.height-1)===0;
n=H(c.format);m=H(c.type);I(k.TEXTURE_CUBE_MAP,c,l);for(j=0;j<6;j++)k.texImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,n,n,m,e[j]);c.generateMipmaps&&l&&k.generateMipmap(k.TEXTURE_CUBE_MAP);c.needsUpdate=false;if(c.onUpdate)c.onUpdate()}else{k.activeTexture(k.TEXTURE0+e);k.bindTexture(k.TEXTURE_CUBE_MAP,c.image.__webglTextureCube)}}else if(m instanceof THREE.WebGLRenderTargetCube){c=m;k.activeTexture(k.TEXTURE0+j);k.bindTexture(k.TEXTURE_CUBE_MAP,c.__webglTexture)}else O.setTexture(m,j)}else if(l==="tv"){if(c._array===
void 0)c._array=[];l=0;for(n=c.value.length;l<n;l++)c._array[l]=v();k.uniform1iv(e,c._array);l=0;for(n=c.value.length;l<n;l++){m=c.value[l];j=c._array[l];m&&O.setTexture(m,j)}}}if((d instanceof THREE.ShaderMaterial||d instanceof THREE.MeshPhongMaterial||d.envMap)&&h.cameraPosition!==null){b=a.matrixWorld.getPosition();k.uniform3f(h.cameraPosition,b.x,b.y,b.z)}(d instanceof THREE.MeshPhongMaterial||d instanceof THREE.MeshLambertMaterial||d instanceof THREE.ShaderMaterial||d.skinning)&&h.viewMatrix!==
...
i],3,k.FLOAT,false,0,0);if(d.morphNormals){k.bindBuffer(k.ARRAY_BUFFER,f.__webglMorphNormalsBuffers[h[i]]);k.vertexAttribPointer(c["morphNormal"+i],3,k.FLOAT,false,0,0)}e.__webglMorphTargetInfluences[i]=g[h[i]];i++}}else{h=[];g=e.morphTargetInfluences;var j,n=g.length;for(j=0;j<n;j++){i=g[j];i>0&&h.push([j,i])}if(h.length>d.numSupportedMorphTargets){h.sort(l);h.length=d.numSupportedMorphTargets}else h.length>d.numSupportedMorphNormals?h.sort(l):h.length===0&&h.push([0,0]);for(i=0;i<d.numSupportedMorphTargets;){if(h[i]){j=
...
THREE.ParticleBasicMaterial&&(n="particle_basic");if(n){var o=THREE.ShaderLib[n];a.uniforms=THREE.UniformsUtils.clone(o.uniforms);a.vertexShader=o.vertexShader;a.fragmentShader=o.fragmentShader}var p,q;p=h=e=f=o=0;for(g=b.length;p<g;p++){q=b[p];if(!q.onlyShadow){q instanceof THREE.DirectionalLight&&h++;q instanceof THREE.PointLight&&e++;q instanceof THREE.SpotLight&&f++;q instanceof THREE.HemisphereLight&&o++}}if(e+f+h+o<=fa){p=h;g=f}else{p=Math.ceil(fa*h/(e+h));g=e=fa-p;o=p}f=p;h=o;o=m=0;for(p=b.length;o<
p;o++){q=b[o];if(q.castShadow){q instanceof THREE.SpotLight&&m++;q instanceof THREE.DirectionalLight&&!q.shadowCascade&&m++}}if(ec&&d&&d.useVertexTexture)l=1024;else{b=k.getParameter(k.MAX_VERTEX_UNIFORM_VECTORS);b=Math.floor((b-20)/4);if(d!==void 0&&d instanceof THREE.SkinnedMesh){b=Math.min(d.bones.length,b);b<d.bones.length&&console.warn("WebGLRenderer: too many bones - "+d.bones.length+", this GPU supports just "+b+" (try OpenGL instead of ANGLE)")}l=b}var t;a:{q=a.fragmentShader;p=a.vertexShader;
...
THREE.TrackballControls=function(a,b){function c(a){if(d.enabled){a.preventDefault();a.stopPropagation();var b=0;a.wheelDelta?b=a.wheelDelta/40:a.detail&&(b=-a.detail/3);j.y=b*0.05;o.y=0}}THREE.EventTarget.call(this);var d=this;this.object=a;this.domElement=b!==void 0?b:document;this.enabled=true;this.screen={width:0,height:0,offsetLeft:0,offsetTop:0};this.radius=(this.screen.width+this.screen.height)/4;this.rotateSpeed=1;this.zoomSpeed=1.2;this.panSpeed=0.3;this.staticMoving=this.noPan=this.noZoom=
this.noRotate=false;this.dynamicDampingFactor=0.2;this.minDistance=0;this.maxDistance=Infinity;this.keys=[65,83,68];this.target=new THREE.Vector3;var f=new THREE.Vector3,e=false,g=-1,h=new THREE.Vector3,i=new THREE.Vector3,l=new THREE.Vector3,j=new THREE.Vector2,o=new THREE.Vector2,m=new THREE.Vector2,p=new THREE.Vector2,q={type:"change"};this.handleResize=function(){this.screen.width=window.innerWidth;this.screen.height=window.innerHeight;this.screen.offsetLeft=0;this.screen.offsetTop=0;this.radius=
...
e=d.object.up.clone().setLength(c.y);e.addSelf(d.object.up.clone().crossSelf(h).setLength(c.x));e.addSelf(h.setLength(c.z));return e};this.rotateCamera=function(){var a=Math.acos(i.dot(l)/i.length()/l.length());if(a){var b=(new THREE.Vector3).cross(i,l).normalize(),c=new THREE.Quaternion,a=a*d.rotateSpeed;c.setFromAxisAngle(b,-a);c.multiplyVector3(h);c.multiplyVector3(d.object.up);c.multiplyVector3(l);if(d.staticMoving)i=l;else{c.setFromAxisAngle(b,a*(d.dynamicDampingFactor-1));c.multiplyVector3(i)}}};
this.zoomCamera=function(){var a=1+(o.y-j.y)*d.zoomSpeed;if(a!==1&&a>0){h.multiplyScalar(a);d.staticMoving?j=o:j.y=j.y+(o.y-j.y)*this.dynamicDampingFactor}};this.panCamera=function(){var a=p.clone().subSelf(m);if(a.lengthSq()){a.multiplyScalar(h.length()*d.panSpeed);var b=h.clone().crossSelf(d.object.up).setLength(a.x);b.addSelf(d.object.up.clone().setLength(a.y));d.object.position.addSelf(b);d.target.addSelf(b);d.staticMoving?m=p:m.addSelf(a.sub(p,m).multiplyScalar(d.dynamicDampingFactor))}};this.checkDistances=
function(){if(!d.noZoom||!d.noPan){d.object.position.lengthSq()>d.maxDistance*d.maxDistance&&d.object.position.setLength(d.maxDistance);h.lengthSq()<d.minDistance*d.minDistance&&d.object.position.add(d.target,h.setLength(d.minDistance))}};this.update=function(){h.copy(d.object.position).subSelf(d.target);d.noRotate||d.rotateCamera();d.noZoom||d.zoomCamera();d.noPan||d.panCamera();d.object.position.add(d.target,h);d.checkDistances();d.object.lookAt(d.target);if(f.distanceToSquared(d.object.position)>
0){d.dispatchEvent(q);f.copy(d.object.position)}};this.domElement.addEventListener("contextmenu",function(a){a.preventDefault()},false);this.domElement.addEventListener("mousemove",function(a){if(d.enabled){if(e){i=l=d.getMouseProjectionOnBall(a.clientX,a.clientY);j=o=d.getMouseOnScreen(a.clientX,a.clientY);m=p=d.getMouseOnScreen(a.clientX,a.clientY);e=false}g!==-1&&(g===0&&!d.noRotate?l=d.getMouseProjectionOnBall(a.clientX,a.clientY):g===1&&!d.noZoom?o=d.getMouseOnScreen(a.clientX,a.clientY):g===
